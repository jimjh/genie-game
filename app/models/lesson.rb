...
# - +name+ can be any string value, although the controllers (with knowledge of
#   GitHub's conventions) might set this to the repository's name for easier web
#   hooking. This is not validated, because the model should be
#   provider-independent. It defaults to +basename url+.
